...
static const char *fonts[]          = { "Fira Code:size=11", "Iosevka Nerd Font:size=8" };
...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_fg0, col_bg1, col_fg1 },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_bg0, "-nf", col_fg1, "-sb", col_bg1, "-sf", col_fg0, NULL };
